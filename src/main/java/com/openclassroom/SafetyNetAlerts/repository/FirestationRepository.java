 ...
 */
    ...
    @lombok.Generated
    public List<String> findAddressesByFirestation(Integer station) {
    List<String> addresses = new ArrayList<>();
        for (Firestation firestation : this.firestations) {
            Integer firestationStation = Integer.parseInt(firestation.getStation());
            if (firestationStation.equals(station)) {
